...
create table cat_domain (id bigint generated by default as identity, category varchar(255), completed boolean, name varchar(255), rank integer, my_house_id bigint, primary key (id));
